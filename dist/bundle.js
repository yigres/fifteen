...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((randomize = (lodash__WEBPACK_IMPORTED_MODULE_0___default().shuffle)) => {
  ...
  document.addEventListener('keyup', e => {
    fifteen.count += 1; // console.log(fifteen.count);
